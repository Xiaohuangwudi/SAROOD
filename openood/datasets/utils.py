...
def get_dataloader(config: Config):
    ...
    for split in dataset_config.split_names:
        ...
        if split_config.dataset_class == 'ImglistExtraDataDataset':
            ...
            CustomDataset = eval(split_config.dataset_class)  # Imglistdataset
...
def get_ood_dataloader(config: Config):
    ...
    ood_config = config.ood_dataset   # dataset_ood.yml
    CustomDataset = eval(ood_config.dataset_class)  # imglistdataset
    dataloader_dict = {}
