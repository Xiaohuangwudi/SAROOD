...
class OODEvaluator(BaseEvaluator):
    ...
    def eval_ood(self,
        ...
        if self.config.postprocessor.APS_mode:
            ...
            self.hyperparam_search(net, id_data_loaders['val'],
                                   ood_data_loaders['val'], postprocessor)  # find a hyperparam, best AUROC in val datasets 
    ...
    def _eval_ood(self,
                  ...
                  ood_data_loaders: Dict[str, Dict[str, DataLoader]],
                  postprocessor: BasePostprocessor,  # ash
        ...
        for dataset_name, ood_dl in ood_data_loaders[ood_split].items():
            print(f'Performing inference on {dataset_name} dataset...',
                  flush=True)
            ood_pred, ood_conf, ood_gt, _ = postprocessor.inference(net, ood_dl)
